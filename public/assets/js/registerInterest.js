window.cfields = { "23": "job_title", "12": "mobile_phone", "3": "country", "4": "nature_of_business", "61": "aim_portfolio", "275": "aim_partnership_types", "228": "aim_interests", "229": "aim_download_brochure", "230": "aim_download_sponsorship_packages", "231": "aim_subscribe_to_newsletter", "365": "aim_sponsorship_budget_range", "366": "aim_preferred_sponsorship_package", "368": "aim_preferred_title_sponsor", "367": "aim_target_market_for_sponsorship", "6": "message", "328": "mainsource", "329": "subsource", "38": "forms_submitted" };
    ...
    var form_submit = function (e) {
        ...
        if (validate_form()) {
            ...
            if ($("#brochure").prop("checked") == true) {
                downloadDocument("AIM Brochure 2026.pdf", "https://assets-us-01.kc-usercontent.com/615577b9-4e2b-0074-b4f8-20f11d30f5ae/0ac855ad-c61a-49d6-affe-5d8c20a65251/AIM%20Brochure%202026.pdf");
            }
            ...
            var PreferredTitleSponsorDetails = $('input[name="field[368]"]').val() || 'N/A';
            ...
            var SponsorsDetails = ''
            SponsorsDetails = SponsorsDetails + `Preferred Sponsorship Package: ${PreferredSponsorshipPackage}  \\\\n` + '\\\\n'
            SponsorsDetails = SponsorsDetails + `Preferred Title Sponsor Details: ${PreferredTitleSponsorDetails}  \\\\n` + '\\\\n'
            SponsorsDetails = SponsorsDetails + `Sponsorship Budget Range: ${SponsorshipBudgetRange}  \\\\n` + '\\\\n'
            SponsorsDetails = SponsorsDetails + `Target Countries: ${TargetCountries}  \\\\n` + '\\\\n'
