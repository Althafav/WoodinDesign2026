window.cfields = { "23": "job_title", "12": "mobile_phone", "3": "country", "318": "sws_interests", "323": "sws_book_your_stand", "319": "sws_download_brochure", "320": "sws_download_sponsorship_packages", "322": "sws_subscribe_to_newsletter", "6": "message", "328": "mainsource", "329": "subsource", "38": "forms_submitted" };
window._show_thank_you = function (id, message, trackcmp_url, email) {
    var form = document.getElementById('_form_' + id + '_'), thank_you = form.querySelector('._form-thank-you');
    var firstname = $('input[name="firstname"]').val();
    var lastname = $('input[name="lastname"]').val();
    var fullName = (firstname + ' ' + lastname).trim();
    var nameSlug = fullName.toLowerCase().replace(/\s+/g, '-');
    
    // window.location.href = '/saudi/thank-you/' + encodeURIComponent(nameSlug);
...
window._load_script = function (url, callback, isSubmit) {
    ...
    var submitButton = document.querySelector('#_form_450_submit');
    ...
    var form_submit = function (e) {
        ...
        if ($("#emailValidate").prop("checked") == true) {
            ...
            if ($("#brochure").prop("checked") == true) {
                downloadDocument("Saudi WoodShow - Brochure.pdf", "/saudi/documents/Saudi Brochure.pdf");
            }
            //if ($("#Sponsorship").prop("checked") == true) {
            //    downloadDocument("Sponsorship packages.pdf", "/saudi/documents/DWS 2023 - Sponsorship package.pdf");
            //}
