window.cfields = {
  ...
  3: "country",
  318: "sws_interests",
  323: "sws_book_your_stand",
  319: "sws_download_brochure",
  320: "sws_download_sponsorship_packages",
  322: "sws_subscribe_to_newsletter",
  6: "message",
  328: "mainsource",
  329: "subsource",
  38: "forms_submitted",
...
(function () {
  ...
  var form_submit = function (e) {
    e.preventDefault();
    var submitButton = e.target.querySelector("#_form_450_submit");
    submitButton.disabled = true;
    submitButton.classList.add("processing");
    submitButton.innerHTML = 'Processing... <span class="loader"></span>';
    var serialized = _form_serialize(
      document.getElementById("_form_450_")
    ).replace(/%0A/g, "\\n");
    var err = form_to_submit.querySelector("._form_error");
    ...
    if ($("#brochure").prop("checked") == true) {
      downloadDocument(
        "Saudi WoodShow - Brochure.pdf",
        "/saudi/documents/Saudi Brochure.pdf"
      );
    }
